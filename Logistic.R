...
# 1. Data understanding, preparation and EDA (40%)
  ...
  # Dataset 1: manager_survey_data.csv
    ...
    manager_survey_data <- unique(manager_survey_data)
    nrow(manager_survey_data)
  ...
  # Dataset 3: general_data.csv
    ...
    nrow(general_data)
    general_data <- unique (general_data)
    nrow(general_data)
